...
function mostrarProductos(category) {
  ...
  const filtrados = category === 'todos' ? productos : productos.filter(p => p.category === category);
...
// Toggle carrito
cartToggle.addEventListener('click', () => cart.classList.toggle('active'));
...
confirmPurchase.addEventListener('click', () => {
  ...
  carrito=[]; actualizarCarrito(); checkoutForm.style.display='none';
});

// Pago con tarjeta
cardPaymentBtn.addEventListener('click', () => cardForm.style.display='block');
